...
Route::get('/mobile', 'Auth\User\LoginController@showLoginForm')->name('mobile');
Route::get('/dth', 'Auth\User\LoginController@showLoginForm')->name('dth');
Route::get('/datacard', 'Auth\User\LoginController@showLoginForm')->name('datacard');
Route::get('/broadband', 'Auth\User\LoginController@showLoginForm')->name('broadband');
Route::get('/landline', 'Auth\User\LoginController@showLoginForm')->name('landline');
Route::get('/cabletv', 'Auth\User\LoginController@showLoginForm')->name('cabletv');
Route::get('/metro', 'Auth\User\LoginController@showLoginForm')->name('metro');
Route::get('/gas', 'Auth\User\LoginController@showLoginForm')->name('gas');
Route::get('/water', 'Auth\User\LoginController@showLoginForm')->name('water');
