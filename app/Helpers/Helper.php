        ...
        $str ='<table>
              <tr>
                <td>
                    <a href="'.route('home').'" title="'.env('APP_NAME').'">
                      <img src="'.config("global.THEME_PATH").'/images/logo.png" alt="Quickai" width="165" style="vertical-align:middle" />
                    </a>
                </td>
            ...
            /*
             <td>
                  ...
                  <span style="font-size: 20px;display: block;">CASHBELL.in</span>
